...
use Apie\Core\Exceptions\InvalidPageLimitException;
use Apie\Core\Exceptions\PageIndexShouldNotBeNegativeException;
...
final class SearchFilterRequest
{
     ...
     */
    public static function createFromPsrRequest(ServerRequestInterface $psrRequest): SearchFilterRequest
    {
